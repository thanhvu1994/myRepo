            ...
            <div class="grid-at">
                <?php if(array_key_exists(0,$cities)) : ?>
                    <div class="col-md-3 grid-city">
                        <div class="grid-lo">
                            <a href="<?php echo get_permalink( $cities[0]->ID ).'apartment/'; ?>">
                ...
                <div class="col-md-6 grid-city grid-city1">
                    <div class="grid-me">
                        ...
                        <div class="col-md-8 grid-lo1">
                            <div class=" grid-lo">
                                <a href="<?php echo get_permalink( $cities[2]->ID ).'apartment/'; ?>">
                                    <figure class="effect-layla">
                                        <?php
                        ...
                        <div class="col-md-4 grid-lo2">
                            <div class=" grid-lo">
                                <a href="<?php echo get_permalink( $cities[3]->ID ).'apartment/'; ?>">
                                    <figure class="effect-layla">
                                        <?php
                    ...
                    <div class="grid-me">
                        ...
                        <div class="col-md-6 grid-lo3">
                            <div class=" grid-lo">
                                <a href="<?php echo get_permalink( $cities[4]->ID ).'apartment/'; ?>">
                                    <figure class="effect-layla">
                                        <?php
                        ...
                        <div class="col-md-6 grid-lo4">
                            <div class=" grid-lo">
                                <a href="<?php echo get_permalink( $cities[5]->ID ).'apartment/'; ?>">
                                    <figure class="effect-layla">
                                        <?php
