            ...
            <div id="left_column" class="column col-xs-12 col-sm-3"><!-- Block categories module -->
                <div id="categories_block_left" class="block">
                    ...
                    <div class="block_content">
                        <ul class="tree dhtml">
                            <li>
                                <a href="<?php echo base_url('tin-tuc.html'); ?>" title="<?php echo ($this->session->userdata['languages'] == 'vn') ? 'Tin Tức' : 'News'; ?>">
                                ...
                                <ul>
                                    <?php foreach($treeCategory as $cate): ?>
                                        <li>
                                            ...
                                            ?>
                                            <a href="<?php echo ($cate['slug'])? base_url($cate['slug'].'n.html') : 'javascript:void(0)'; ?>" <?php echo $selected; ?> title="<?php echo $cate['title']; ?>">
                                                <?php echo $cate['title']; ?>
                                            </a>
                                                ...
                                                <ul>
                                                    <?php foreach($cate['child'] as $childCate): ?>
                                                        <li>
                                                            ...
                                                            ?>
                                                            <a href="<?php echo base_url($childCate['slug'].'n.html'); ?>" <?php echo $selected; ?> title="<?php echo $childCate['title']; ?>">
