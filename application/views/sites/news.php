                        ...
                        <div id="smartblogpost-<?php echo $new->id; ?>">
                            <div class="sdsarticleHeader">
                                ...
                                <span>Posted by
                                    ...
                                    <span class="comment"> &nbsp;<i class="icon icon-comments"></i>&nbsp; <div style="display: inline-block;" class="fb-comments-count" data-href="<?php echo base_url('sites/newDetail/'. $new->slug); ?>">0</div> Comments</span>&nbsp;
                                    <i class="icon icon-eye-open"></i> views (<?php echo $new->views; ?>)</span>
                            </div>
                            ...
                            <div class="sdsarticle-des">
                                ...
                                <div class="sdsreadMore">
                                    <span class="more"><a title="<?php echo $new->title; ?>" href="<?php echo base_url('sites/newDetail/'.$new->slug); ?>" class="r_more button-medium">Read more</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
