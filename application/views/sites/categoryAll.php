            ...
            <div id="left_column" class="column col-xs-12 col-sm-3"><!-- Block categories module -->
                <div id="categories_block_left" class="block">
                    ...
                    <div class="block_content">
                        <ul class="tree dhtml">
                            <li>
                                <a class="selected" href="<?php echo base_url('danh-muc.html');?>" title="<?php echo ($this->session->userdata['languages'] == 'vn') ? 'Sản Phẩm' : 'Products'; ?>">
                                    <?php echo ($this->session->userdata['languages'] == 'vn') ? 'Sản Phẩm' : 'Products'; ?>
                                </a>
                                <ul>
                                    <?php foreach($treeCategory as $cate): ?>
                                        <li>
                                            <a href="<?php echo ($cate['slug'])? base_url($cate['slug'].'c.html') : 'javascript:void(0)'; ?>" title="<?php echo $cate['title']; ?>">
                                                <?php echo $cate['title']; ?>
                                            </a>
                                            <?php if(!empty($cate['child'])): ?>
                                                <ul>
                                                    <?php foreach($cate['child'] as $childCate): ?>
                                                        <li>
                                                            <a href="<?php echo base_url($childCate['slug'].'c.html'); ?>" title="<?php echo $childCate['title']; ?>">
