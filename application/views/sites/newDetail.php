        ...
        <div class="row">
            ...
            <div id="center_column" class="center_column col-xs-12 col-sm-8">
                    ...
                    <div itemtype="#" itemscope="" id="sdsblogArticle" class="blog-post">
                        ...
                        <div class="post-info">
                            <span><?php echo ($this->session->userdata['languages'] == 'vn') ? 'Đăng Bởi' : 'Posted By'; ?>  &nbsp;<i class="icon icon-user"></i><span itemprop="author">Admin</span>&nbsp;
                                ...
                                <i class="icon icon-comments"></i>&nbsp; <div style="display: inline-block;" class="fb-comments-count" data-href="<?php echo base_url('tin-tuc/'.$new->getCategoryLink().'/'.$new->slug); ?>">0</div> <?php echo ($this->session->userdata['languages'] == 'vn') ? 'Bình Luận' : 'Comments'; ?></span>
                ...
                <div class="smartblogcomments" id="respond">
                    <div data-width="100%" class="fb-comments" data-href="<?php echo base_url('tin-tuc/'.$new->getCategoryLink().'/'.$new->slug); ?>" data-numposts="5"></div>
                </div>
